function varargout = gui_polyline_sympl_unix(varargin)
% GUI_POLYLINE_SYMPL_UNIX M-file for gui_polyline_sympl_unix.fig
%      GUI_POLYLINE_SYMPL_UNIX, by itself, creates a new GUI_POLYLINE_SYMPL_UNIX or raises the existing
%      singleton*.
%
%      H = GUI_POLYLINE_SYMPL_UNIX returns the handle to a new GUI_POLYLINE_SYMPL_UNIX or the handle to
%      the existing singleton*.
%
%      GUI_POLYLINE_SYMPL_UNIX('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_POLYLINE_SYMPL_UNIX.M with the given input arguments.
%
%      GUI_POLYLINE_SYMPL_UNIX('Property','Value',...) creates a new GUI_POLYLINE_SYMPL_UNIX or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_polyline_sympl_unix_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_polyline_sympl_unix_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help gui_polyline_sympl_unix

% Last Modified by GUIDE v2.5 07-Oct-2010 15:15:00

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name', mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @gui_polyline_sympl_unix_OpeningFcn, ...
    'gui_OutputFcn',  @gui_polyline_sympl_unix_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before gui_polyline_sympl_unix is made visible.
function gui_polyline_sympl_unix_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_polyline_sympl_unix (see VARARGIN)

% Choose default command line output for gui_polyline_sympl_unix
...
function varargout = gui_polyline_sympl_unix_OutputFcn(hObject, eventdata, handles)  %#ok<*STOUT,*INUSD>
