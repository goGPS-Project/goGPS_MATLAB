function [data] = decode_1001(msg, constellations)

% SYNTAX:
%   [data] = decode_1001(msg, constellations)
%
% INPUT:
...
%
% OUTPUT:
%   data = cell-array that contains the 1001 packet information
%          1.1) DF002 = message number = 1001
...
%          3.2) (DF011 * 0.02) = code observation vector
...
%
% DESCRIPTION:
%   RTCM format 1001 message decoding.
...
data{1} = 0;
data{2} = zeros(6,1);
data{3} = zeros(constellations.nEnabledSat,4);
