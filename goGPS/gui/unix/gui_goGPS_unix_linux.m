function varargout = gui_goGPS_unix_linux(varargin)
% GUI_GOGPS_UNIX M-file for gui_goGPS_unix_linux.fig
...
% Edit the above text to modify the response to help gui_goGPS_unix_linux

% Last Modified by GUIDE v2.5 18-Mar-2014 16:55:24
...
% --- Executes just before gui_goGPS_unix_linux is made visible.
function gui_goGPS_unix_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to gui_goGPS_unix_linux (see VARARGIN)
clearvars -global goGUI
global goGUI
goGUI = goGUIclass(handles, goGUIclass.isUnix);

% UIWAIT makes gui_goGPS_unix_linux wait for user response (see UIRESUME)
uiwait(hObject);
