...
%  Contributors:     Gatti Andrea, Daisuke Yoshida, ...
...
classdef Sat_Lib < handle

    properties (Constant)
        QUARTER_SEC = 900; % number of seconds in a quarter of an hour
    end
    ...
    properties % Public Access
        ...
        time;     % time of reference
        sun_pos;  % position of the sun at "time"
        moon_pos; % position of the moon at "time"

        antenna_pcv; % phase center variation of satellite antennas
        antenna_pco; %
        sat_type;
    end
    ...
    methods (Static)
        ...
        function this = getInstance()
            ...
            persistent unique_instance_sat_lib__
            unique_instance_sat_lib__ = [];

            if isempty(unique_instance_sat_lib__)
                this = Sat_Lib();
                unique_instance_sat_lib__ = this;
            else
                this = unique_instance_sat_lib__;
            end
        end
    end
    % =========================================================================
