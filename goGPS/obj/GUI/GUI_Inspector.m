...
classdef GUI_Inspector < GUI_Unique_Win   
    ...
    properties (Constant, Access = 'protected')
        ...
        RES_TYPE = {'Combined (or single freq.)', 'Uncombined Pseudo-Ranges', 'Uncombined Carrier Phases'}
    end
    ...
    methods (Access = 'private')
        ...
        function insertTabPlots2(this, container)
            ...
            uicontrol( 'Parent', workspace_box, ...
                'String', 'Residuals statistics', ...
                'TooltipString', 'Plot of the residuals mean and std satellite by satellite', ...
                'UserData', {'SHOW T@ RES_(O|W)_(RTYPE)S'}, ...
                'Callback', @this.onInsertCommand);
                                                
%             uicontrol( 'Parent', workspace_box, ...
%                 'String', 'Residuals on a unique plot', ...
%                 'TooltipString', 'Plot residuals in a unique plot', ...
%                 'UserData', {'SHOW T@ RES_(O|W)_(RTYPE)1'}, ...
%                 'Callback', @this.onInsertCommand);
% 
%             uicontrol( 'Parent', workspace_box, ...
%                 'String', 'Residuals on separate plots', ...
...
%             v_align.Heights = [4 -1];
%             
%             bsl_ref_ids = uicontrol('Parent', but_sub_line, ...
%                 'Style', 'edit', ...
%                 'String', 'auto', ...
...
%             v_align.Heights = [4 -1];
%             
%             rds_ref_ids = uicontrol('Parent', but_sub_line, ...
%                 'String', 'auto', ...
%                 'TooltipString', 'Insert comma separated radiosondes ids or "auto"', ...
%                 'Style', 'edit', ...
%                 'FontName', 'Courier New', ...
%                 'FontWeight', 'bold', ...
%                 'HorizontalAlignment', 'center', ...
...
%                 'Callback', @this.onInsertCommand);    
        ...
        function insertTabExport(this, container)
            ...
            out_pnl = Core_UI.insertPanelLight(eg_box, 'Receiver Specific');
            out_box = uix.VButtonBox('Parent', out_pnl, ...
                'ButtonSize', [340 28] , ...
                'Spacing', 0, ...
                'HorizontalAlignment', 'left', ...
            ...
            uicontrol( 'Parent', out_box, ...
                'String', 'Export receiver RINEX3 of the last session', ...
            ...
            uicontrol( 'Parent', out_box, ...
                'String', 'Export receiver TROposphere (as HN)', ...
    ...
    methods (Access = public)                 
        ...
        function onInsertCommand(this, caller, event)            
            ...
            if this.res_type.Value == 1 % CODE
                new_cmd = strrep(new_cmd, '(RTYPE)', 'CO');
            elseif this.res_type.Value == 2 % PR
                new_cmd = strrep(new_cmd, '(RTYPE)', 'PR');                
            elseif this.res_type.Value == 3 % PH
