    ...
    methods (Access = 'private')
        ...
        function insertTabSimplePlots(this, container)
            ...
            uicontrol( 'Parent', but_line, ...
                ...
                'TooltipString', 'Processing Stats (multi-session only)', ...
            ...
            uicontrol( 'Parent', but_line, ...
                ...
                'TooltipString', 'Pos Stability ENU (requires more than 1 pos)', ...
                'UserData', {'SHOW T@ ENU'}, ...
                'Callback', @this.onInsertCommand);
            
            uicontrol( 'Parent', but_line, ...
                'String', 'Pos. Stability XYZ', ...
                'TooltipString', 'Pos Stability XYZ (requires more than 1 pos)', ...
                'UserData', {'SHOW T@ XYZ'}, ...
                'Callback', @this.onInsertCommand);
            ...
            uicontrol( 'Parent', but_line, ...
                'String', 'N. Satellites', ...
                'TooltipString', 'Number of Satellites (all the receiver at once)', ...
