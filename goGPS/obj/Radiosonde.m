classdef Radiosonde < handle
    ...
    methods (Static)
        ...
        function fh_list = showMap(sta_list, new_fig, flag_labels)
            ...
            %
            % SYNTAX
            %   Radiosonde.showMap(sta_list, new_fig, resolution);
            %
            % EXAMPLE
            ...
            if flag_large_points
                for r = 1 : numel(x)
                    plot(x(r), y(r), '.', 'MarkerSize', 45, 'Color', Core_UI.getColor(r, numel(x)));
                end
        ...
        function name = getRaobName(sta_num)
