...
classdef Prj_Settings < Settings_Interface & Command_Settings
    ...
    properties (Constant, Access = 'public')
        ...
        FLAG_REC_MP_LABEL = {'none', ...
          ...
          '(1) + stacking maps with congruent cells', ...
          'Stacking map with cells [5 x 1]', ...
          'Stacking map with congruent cells [5 x 1]', ...
          'Stacking map with cells [1 x 1]', ...
          'Stacking map with congruent cells [1 x 1]'}
