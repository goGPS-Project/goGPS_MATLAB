...
classdef Core_UI < handle
    ...
    properties (Constant)
        FONT_SIZE_CONVERSION_LNX = 0.8;
        FONT_SIZE_CONVERSION_MAC = 1;
    ...
    methods        
        ...
        function szcnv = getSizeConversion(this)
            if isunix()
                if ismac()
                    szcnv = this.FONT_SIZE_CONVERSION_MAC;
                else
                    szcnv = this.FONT_SIZE_CONVERSION_LNX;
                end
            else
                 szcnv = this.FONT_SIZE_CONVERSION_WIN;
            end
        end
