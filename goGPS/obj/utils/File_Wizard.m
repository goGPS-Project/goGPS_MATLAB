                                                       ...
                                                       'mxd', struct('path', '/gnss/', ...
                                                                     'center', struct('gbm', struct('name', 'GeoForschungsZentrum Potsdam (GFZ)', ...
                                                                                      ...
                                                                                      'tum', struct('name', 'Technische Universitaet Muenchen', ...
                                                                                                    'eph', struct('final', 'products/mgex/${WWWW}/tum${WWWWD}.sp3', ...
                                                                                                                  'broadcast',  'data/campaign/mgex/daily/rinex3/${YYYY}/brdm/brdm${DOY}0.${YY}p'), ...
                                                                                                    'clk', struct('final', 'products/mgex/${WWWW}/tum${WWWWD}.sp3'), ...
                                                                                                    'erp', struct('final', 'products/mgex/${WWWW}/tum${WWWWD}.erp'), ...
                                                                                                    'bds', struct('final', 'products/mgex/${WWWW}/tum${WWWWD}.bias'))...
                                                                                                ))))... %);
