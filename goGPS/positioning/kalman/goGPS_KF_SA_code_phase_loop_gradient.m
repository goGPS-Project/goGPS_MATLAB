...
if (flag_tropo)
    Cvv(o3+nN+1:o3+nN+1,o3+nN+1:o3+nN+1) = sigmaq_tropo;
    if (flag_tropo_gradient)
        Cvv(o3+nN+1:o3+nN+[2:nT],o3+nN+1:o3+nN+[2:nT]) = sigmaq_tropo_gradient;
    end
end
...
if (flag_tropo)
    ...
    if (~flag_tropo_gradient)
        ...
        ZWD = apriori_ZWD + delta_ZWD + cotd(elR(sat_pr,1))*(grad_ZWD_N*cosd(azR(sat_pr,1)) + grad_ZWD_E*sind(azR(sat_pr,1)));
    end
