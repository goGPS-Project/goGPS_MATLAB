...
classdef GUI_Msg < GUI_Unique_Win   
    ...
    methods
        ...
        function clear(this)
            ...
            Core_UI.guiAddMessage(this.jedt, ['<p><b>Welcome to goGPS!</b></p><p>This software is brought to you by GReD s.r.l.</p>for any problem contact us at <a color="' rgb2hex(Core_UI.LBLUE) '" source="http://bit.ly/goGPS">http://bit.ly/goGPS</a>'], 'm');            
