...
% SEE ALSO
%   - Least_Square
% FOR A LIST OF CONSTANTs and METHODS use doc Engine_U1
            ...
            if ~direct_solve % for small system does not make sense to go trough all this pain
                ...
                if is_network
                    ...
                    if ~isempty(idx_net_comm)
                        ...
                        if ~isempty(this.distance_regularization) && Core.isReserved
        ...
        function [resulting_gps_time, idxes, sat_jmp_idx] = intersectObsSet(obs_set_lst)
            ...
            for i = 1 : n_rec
                ...
                for j = 1 : n_sat
                    ...
                    % get one epoch arcs
                    [flag_intervals] = getFlagsLimits(presence_mat(:,j)>1);
