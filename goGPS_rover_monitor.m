...
for r = 1 : nrec
    ...
    if (protocol(r) == 0)
        ...
        reply_save = ublox_CFG_CFG(rover{r}, 'save');
        tries = 0;
        ...
        reply_RATE = ublox_CFG_RATE(rover{r}, 1000, 1, 1);
        tries = 0;
        ...
        reply_RAW = ublox_CFG_MSG(rover{r}, 'RXM', 'RAW', 1);
        tries = 0;
        ...
        reply_SFRB = ublox_CFG_MSG(rover{r}, 'RXM', 'SFRB', 0);
        tries = 0;
        ...
        ublox_CFG_MSG(rover{r}, 'NMEA', 'GGA', 1); fprintf('Enabling GGA...\n');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'GLL', 0); fprintf('Disabling GLL ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'GSA', 0); fprintf('GSA ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'GSV', 0); fprintf('GSV ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'RMC', 0); fprintf('RMC ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'VTG', 0); fprintf('VTG ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'GRS', 0); fprintf('GRS ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'GST', 0); fprintf('GST ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'ZDA', 0); fprintf('ZDA ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'GBS', 0); fprintf('GBS ');
        ublox_CFG_MSG(rover{r}, 'NMEA', 'DTM', 0); fprintf('DTM ');
        ublox_CFG_MSG(rover{r}, 'PUBX', '00', 0); fprintf('PUBX00 ');
        ublox_CFG_MSG(rover{r}, 'PUBX', '01', 0); fprintf('PUBX01 ');
        ublox_CFG_MSG(rover{r}, 'PUBX', '03', 0); fprintf('PUBX03 ');
        ublox_CFG_MSG(rover{r}, 'PUBX', '04', 0); fprintf('PUBX04\n');
