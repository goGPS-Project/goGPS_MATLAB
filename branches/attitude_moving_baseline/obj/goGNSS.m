...
classdef goGNSS < handle
    ...
    properties (Constant)
        ...
        MODE_PP_KF_CP_SA_MR  = 18;  % Post Proc Kalman Filter on Code and Phase Stand Alone for moving baseline attitude estimation
        ...
        MODE_PP_KF_CP_DD_MR_BS = 19;% Post Proc Kalman Filter on Code and Phase for moving baseline attitude estimation, with base station
        ...
        GMODE_PP = [ goGNSS.MODE_PP_LS_C_SA ...     % Group of post processing modes
            ...
            goGNSS.MODE_PP_KF_CP_SA_MR ...
            goGNSS.MODE_PP_KF_CP_DD_MR_BS ...
