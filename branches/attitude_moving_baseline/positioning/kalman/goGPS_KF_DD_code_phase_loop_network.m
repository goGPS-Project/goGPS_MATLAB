function [check_on, check_off, check_pivot, check_cs, H, y0, Cnn, Cvv, Cee, nsat, sat_np] = goGPS_KF_DD_code_phase_loop_network ...
...
%   distance = constraint length of baseline
%
% OUTPUT:
