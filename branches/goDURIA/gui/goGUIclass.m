...
classdef goGUIclass < handle
    ...
    properties (Constant)
        ...
        mode_PP_LS_CP_DD_L = 13;  % Post Proc Least Squares Code and Phase Double Differencies with Lambda
        mode_PP_LS_CP_Vel = 3.1;  % Post Proc Least Squares Code and Phase for Velocity estimation
    ...
    % Look initPopUps for the complete initialization
        ...
        %idCP_DD_L = 3;  % Code and phase double difference with Lambda
        idCP_Vel = 3    % Variometric approach for velocity estimation
    ...
    methods
        ...
        function checkUIdependencies(obj)
          ...
          % --------------------------------------------------------------- 
            ...
            if obj.isRinex()
                if (obj.isLS() && (obj.isProcessingType(obj.idC_SA) || obj.isProcessingType(obj.idCP_Vel))) || ...
