function goGPS_LS_SA_goDURIA(time_rx_t0,time_rx_t1,pr1_t0,pr1_t1,pr2_t0, pr2_t1, ph1_t0,ph1_t1, ph2_t0,ph2_t1, snr_t0,snr_t1, Eph_t0,Eph_t1, SP3_time_t0,SP3_time_t1, SP3_coor_t0,SP3_coor_t1, SP3_clck_t0,SP3_clck_t1, iono, phase,time_step);
...
if (size(sat,1) >= 4)
    ...
    if (phase == 1)
        ...
        sat_pr_t0=sat_pr;
        sat_pr=sat_pr_old;
        [XR_t1, dtR_t1, XS_t1, dtS_t1, XS_tx_t1, VS_tx_t1, time_tx_t1, err_tropo_t1, err_iono_t1, sat_pr, elR(sat_pr), azR(sat_pr), distR(sat_pr), cov_XR_t1, var_dtR_t1, PDOP, HDOP, VDOP, cond_num] = init_positioning(time_rx_t1, pr1_t1(sat_pr), snr_t1(sat_pr), Eph_t0, SP3_time_t1, SP3_coor_t1, SP3_clck_t1, iono, [], [], [], sat_pr, cutoff, snr_threshold, 0, 0); %#ok<ASGLU>
...
%else
 ...
 %5   N2 = zeros(32,1);
    ...
    if ~isempty(sat)
        [XR, dtR, cov_XR, var_dtR,  PDOP, HDOP, VDOP] = LS_SA_code_goDURIA(XR_t0,XR_t1, XS_t0,XS_t1,  ph1_t0(sat_pr),ph1_t1(sat_pr), snr_t0(sat_pr),snr_t1(sat_pr), elR(sat_pr), distR_t0(sat_pr), distR_t1(sat_pr), sat_pr, sat, dtS_t0,dtS_t1, err_tropo_t0,err_tropo_t1, err_iono_t0,err_iono_t1, 1); %#ok<ASGLU>
    end
