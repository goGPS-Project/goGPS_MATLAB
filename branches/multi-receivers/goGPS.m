...
if (mode_user == 1)
    ...
    % mode=15 --> KALMAN FILTER ON PHASE AND CODE DOUBLE DIFFERENCES FOR MULTIPLE RECEIVERS
    ...
    % mode=8  --> KALMAN FILTER ON PHASE AND CODE DOUBLE DIFFERENCES
    %             WITHOUT A CONSTRAINT for several receivers
    % mode=9  --> ....
    % REAL-TIME
