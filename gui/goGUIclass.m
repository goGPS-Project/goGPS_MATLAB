    ...
    methods (Access = 'private');
        ...
        function initUIids(obj)
          ...
          % ---------------------------------------------------------------
            ...
            idG.onPP_LS_C_SA = [idG.onPP_LS id.cPlotProc idG.pGNSS ...
                                id.cUse_SBAS];
            
            % On Post Proc => Least Squares => Code Double Differences
            idG.onPP_LS_C_DD = [idG.onPP_LS id.cPlotProc idG.pGNSS ...
                                id.pMSt id.cMPos];
            ...
            idG.onPP_KF_C_SA = [idG.onPP_KF id.rBin idG.pGNSS ...
                               id.cUse_SBAS];
            
            % On Post Proc => On Kalman Filter => Code Double Differences
            idG.onPP_KF_C_DD = [idG.onPP_KF id.rBin idG.pGNSS ...
                               id.pMSt id.cMPos];
