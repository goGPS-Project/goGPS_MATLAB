...
% GUI_DECODE_STREAM_UNIX M-file for gui_decode_stream_unix.fig
%      GUI_DECODE_STREAM_UNIX, by itself, creates a new GUI_DECODE_STREAM_UNIX or raises the existing
%      singleton*.
%
%      H = GUI_DECODE_STREAM_UNIX returns the handle to a new GUI_DECODE_STREAM_UNIX or the handle to
%      the existing singleton*.
%
%      GUI_DECODE_STREAM_UNIX('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_DECODE_STREAM_UNIX.M with the given input arguments.
%
%      GUI_DECODE_STREAM_UNIX('Property','Value',...) creates a new GUI_DECODE_STREAM_UNIX or raises the
