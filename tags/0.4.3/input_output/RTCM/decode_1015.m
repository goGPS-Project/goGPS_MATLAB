...
%          3.1)  DF068 = GPS satellite ID
%          3.2)  DF074 = Ambiguity status flag (0 = reserved, 1 = Correct Integer Ambiguity Level for L1 and L2, 2 = Correct Integer Ambiguity Level for L1-L2 widelane, 3 = Uncertain Integer Ambiguity Level)
%          3.3)  DF075 = GPS non sync count (cycle slip counter)
%          3.4)  DF069 = GPS ionospheric carrier phase correction (mm)
%
% DESCRIPTION:
%   RTCM format 1015 message decoding.
